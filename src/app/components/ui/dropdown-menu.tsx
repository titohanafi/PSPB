...
const filterFigmaProps = <T extends Record<string, any>>(props: T): Partial<T> => {
  ...
  // Remove all Figma inspection props that start with _fg (case insensitive)
...
>((props, ref) => {
  ...
  return (
    <DropdownMenuPrimitive.Portal ref={ref} data-slot="dropdown-menu-portal" {...cleanProps} />
  );
});
...
function DropdownMenuGroup(
  ...
  const cleanProps = filterFigmaProps(props);
  return (
    <DropdownMenuPrimitive.Group data-slot="dropdown-menu-group" {...cleanProps} />
  );
}
